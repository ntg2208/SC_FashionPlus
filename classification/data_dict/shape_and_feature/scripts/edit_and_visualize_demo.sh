...
TEXTURE_FEAT_NUM=8
ROOT_DIR='/home/giang.nguyen/FashionStyle/FashionPlus/' # absolute path for FashionPlus


# Editing module options
UPDATE_FNAME=$1 # filename to update 18.jpg
UPDATE_TYPE=$2 # specify whether to edit shape_only, texture_only, or **shape_and_texture**
AUTO_SWAP=$3 # auto_swap is True if automatically deciding which part to swap out; then swapped_partID will be unused True
SWAPPED_PARTID=$4 # swapped_partID specifies which part to update; for class='humanparsing', partID mapping is: 0 top, 1 skirt, 2 pants, 3 dress 0
MAXITER=$5 # editing module stops at maxtier iterations 10
UPDATE_STEP_SZ=$6 # editing module takes step size at each update iteration 0.25

...
def set_dataset_parameters(classname):
    ...
    if classname == 'humanparsing':
        with open('/home/giang.nguyen/FashionStyle/FashionPlus/classification/data_dict/shape_and_feature/datasets/%s/garment_label_part_map.json' % classname, 'r') as readfile:
...
def generate_texture_on_mask_final(outfit_feat_dict, updated_feature):
    ...
    # parentPath = os.path.abspath("../../../generation")
    # if parentPath not in sys.path:
    sys.path.insert(1, '/home/giang.nguyen/FashionStyle/FashionPlus/generation')
    from decode_clothing_features import generation_from_decoded_mask
...
# if parentPath not in sys.path:
sys.path.insert(0, '/home/giang.nguyen/FashionStyle/FashionPlus/classification')

...
with open('shape_opt.pkl', 'wb') as f:
    pickle.dump(opt, f)
...
if demo:
    save_name = os.path.join('/home/giang.nguyen/FashionStyle/FashionPlus/separate_vae/results/Lab/demo/', \
                            '%s_shape_codes.p' % opt.phase)
else:
